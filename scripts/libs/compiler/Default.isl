...
welcomePageTitleLab=Welcome to install %1
welcomePageBackground_colorful=bgWelcom
welcomePageBackground_grey=bgGrey
welcomePageOnkeyBtn=1-Click Upgrade
welcomePageOnkeyBtnSize=13
TyporaNotInstalled=Typora is not detected, please install first!%nNeed to open official website of Typora?
TyporaOfficialWebSite=https://typora.io
haveReadLicense=I have read and agree with our
userLicense= User License Agreement 
positionLeftLicense=266
myAgreementURL=https://taozhiyu.github.io/TyProAction/Agreements.html
aboutTitle=Related Links:
aboutHomePageURL=https://taozhiyu.github.io/TyProAction/
aboutHomePage=Project Homepage
positionTopLicense=412
positionTopAbout=440
positionLeftAboutTitle=50
positionLeftHomePage=150
positionLeftTypora=275
finishPageFinishBtn=Complete Upgrade
finishPageFinishBtnSize=10
