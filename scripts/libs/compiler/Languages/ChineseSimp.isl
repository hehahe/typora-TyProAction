...
welcomePageTitleLab=欢迎安装 %1
welcomePageBackground_colorful=bgWelcom_zh
welcomePageBackground_grey=bgGrey_zh
welcomePageOnkeyBtn=一键升级
welcomePageOnkeyBtnSize=15
TyporaNotInstalled=未检测到Typora，请先安装正版！%n需要打开Typora官网吗？
TyporaOfficialWebSite=https://typoraio.cn
haveReadLicense=我已阅读并同意《             》
userLicense= 用户许可协议 
positionLeftLicense=153
myAgreementURL=https://taozhiyu.github.io/TyProAction/Agreements.zh.html
aboutTitle=相关链接:
aboutHomePageURL=https://taozhiyu.github.io/TyProAction/README.zh.html
aboutHomePage=项目主页
positionTopLicense=428
positionTopAbout=428
positionLeftAboutTitle=460
positionLeftHomePage=525
positionLeftTypora=584
finishPageFinishBtn=完成升级
finishPageFinishBtnSize=15
